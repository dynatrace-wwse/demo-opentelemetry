...
```bash
@sergiohinojosa ➜ /workspaces/demo-opentelemetry (main) $ deployGhdocs 
INFO    -  Cleaning site directory
INFO    -  Building documentation to directory: /workspaces/demo-opentelemetry/site
...
INFO    -  Copying '/workspaces/demo-opentelemetry/site' to 'gh-pages' branch and pushing to GitHub.
...
To https://github.com/dynatrace-wwse/demo-opentelemetry
   bca482c..db42f7f  gh-pages -> gh-pages
INFO    -  Your documentation should shortly be available at: https://dynatrace-wwse.github.io/demo-opentelemetry/
